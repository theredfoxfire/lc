...
class ProfileType extends AbstractType
{
    ...
    {
        $builder
			->add('name', 'text', array('attr'=>array('class'=>'form-control', 'required'=> true,'placeholder'=>'Nama Lengkap'), 'label'=>false))
            ->add('about', 'textarea', array('attr'=>array('class'=>'form-control', 'required'=> true,'placeholder'=>'Tentang Anda'), 'label'=>false))
            ->add('address', 'textarea', array('attr'=>array('class'=>'form-control', 'required'=> true,'placeholder'=>'Alamat lengkap'), 'label'=>false))
