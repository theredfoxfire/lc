...
use Lc\LcBundle\Entity\Education;
use Lc\LcBundle\Form\EducationType;
...
class EducationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LcLcBundle:Education')->findAll();

        return $this->render('LcLcBundle:Education:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('LcLcBundle:Education:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LcLcBundle:Education')->find($id);
        ...
        return $this->render('LcLcBundle:Education:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('LcLcBundle:Education:edit.html.twig', array(
            'entity'      => $entity,
